...
public class CandidateNameDto {
     ...
     * annotation in
     * {@link fr.vilth.sprintplanner.api.repositories.CandidateJpaRepository#findCandidateNameByTaskNameAndStatus
     * findCandidateNameByTaskNameAndStatus}
     * 
     * @see {@link fr.vilth.sprintplanner.api.repositories.JpqlQuery#CANDIDATE_NAME_QUERY
     *      CANDIDATE_NAME_QUERY}
     * @param firstname the candidate firstname
     * @param lastname the candidate lastname
     */
