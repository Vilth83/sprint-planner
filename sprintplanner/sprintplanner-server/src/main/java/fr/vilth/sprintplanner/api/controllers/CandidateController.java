...
public class CandidateController {
	 ...
	 */
	@GetMapping("/{taskName}")
	public Set<CandidateViewDto> findAllByTaskName(@PathVariable String taskName) {
	 ...
	 */
	@PutMapping("/{id}")
	public void update(@Valid @RequestBody CandidateUpdateDto inputs, @PathVariable Long id) {
	...
	public CandidateViewDto getCurrentByTask(@PathVariable String task) {
		return candidateService.findFirstByTaskNameAndStatus(task, Status.CURRENT);
	}
}
