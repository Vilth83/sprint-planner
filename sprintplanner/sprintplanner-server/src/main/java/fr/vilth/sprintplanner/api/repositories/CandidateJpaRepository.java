...
public interface CandidateJpaRepository extends JpaRepository<Candidate, Long> {
     ...
     * @param shift optional : shift given {@code Shift}
     * @return a {@code List} of {@code Candidate}
     */
     ...
     * <p>
     * Return type is a pageable list with only one or zero element, to be sure
     ...
     * @param pageable a PageRequest of 0 or 1 element
     * @return A {@code List} containing a number of {@code Candidate} limited
     *         by the {@code Pageable}.
     */
