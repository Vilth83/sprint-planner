...
public class Ticket {
     ...
     * <p>
     * A {@code Ticket} is considered as test proofed if and only if it contains
     * at least one attachement having "test proof" in its name. the regular
     * expression for "test proof" mention in case insensitive and accepts
     * space, dash and underscore between the two words.
     * 
