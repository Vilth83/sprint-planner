...
public class BeanConfig {
	...
	/**
	 * Default {@code ObjectMapper} bean that configures mapping between JSON and
	 * DTO.
	 * <p>
	 ...
	 * <p>
	 * No specific configuration is needed, so this {@code Bean} returns a standard
	 * {@code RestTemplate}
	 * 
	 ...
	 * <p>
	 * Defines basePackage as "fr.vilth", meaning that every {@code RestController}
	 * is scanned and retrieved by SWAGGER ui.
	 * 
	 * @return a new {@code Docket}
	 */
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("fr.vilth"))
